...
ARDUINO_BOARD = $(ARDUINO)/../../variants/$(VARIENT)
...
$(TARGET).cpp: $(TARGET).pde
	echo '#include "Arduino.h"' >$(TARGET).cpp
...
CDEFS = -DF_CPU=$(F_CPU) -DARDUINO=$(ARDUINO_VER)
CXXDEFS = -DF_CPU=$(F_CPU) -DARDUINO=$(ARDUINO_VER)

# Place -I options here
CINCS = -I$(ARDUINO) -I$(ARDUINO_BOARD)
CXXINCS = -I$(ARDUINO) -I$(ARDUINO_BOARD)
