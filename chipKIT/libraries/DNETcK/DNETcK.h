...
public:
    ...
    typedef enum 
    {
        ...
        // Listening status
        NeedToCallStartListening,
        NeedToResumeListening,
        AlreadyStarted,
        AlreadyListening,
        Listening,
        ExceededMaxPendingAllowed,
        MoreCurrentlyPendingThanAllowed,
        ClientPointerIsNULL,
        SocketAlreadyAssignedToClient,
        NoPendingClients,
        IndexOutOfBounds,
    ...
    static bool begin(const MAC& mac);
    static bool begin(const MAC& mac, const IPv4& ip);
    static bool begin(const MAC& mac, const IPv4& ip, const IPv4& ipGateway);
    static bool begin(const MAC& mac, const IPv4& ip, const IPv4& ipGateway, const IPv4& subnetMask);
    static bool begin(const MAC& mac, const IPv4& ip, const IPv4& ipGateway, const IPv4& subnetMask, const IPv4& ipDns1);
    static bool begin(const MAC& mac, const IPv4& ip, const IPv4& ipGateway, const IPv4& subnetMask, const IPv4& ipDns1, const IPv4& ipDns2);
    
    static void end(void);
    
    static bool isInitialzied(void); 
    static bool isInitialzied(STATUS * pStatus); 
    static bool isInitialzied(unsigned long msBlockMax);
    static bool isInitialzied(unsigned long msBlockMax, STATUS * pStatus);
